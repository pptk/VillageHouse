...
public class YuleModel {
	...
	public YuleModel(String yid,String ytype,String yimage,String ytitle,String yprofile)
	{
		super();
		this.yid=yid;
		this.yimage=yimage;
	...
	public YuleModel(String ytitle,String ycontent,String yphone,String ybimage)
	{
		super();
		this.ytitle=ytitle;
